...
export const techniqueVisuals: TechniqueVisual[] = [
  ...
  },
  {
    ...
    reviewStatus: "needs-master-review",
    reviewNote: "Prototipo de posicion preparada; validar distancia de pies y altura de punios.",
    cues: ["Pies estables", "Punios delante del abdomen", "Hombros relajados", "Mirada al frente"],
  },
  {
    ...
    reviewStatus: "needs-master-review",
    reviewNote: "Prototipo compuesto; validar forma de brazos y altura del golpe con maestro.",
    cues: ["Canto de mano al cuello", "Brazo contrario compensa la forma", "Postura firme", "Foco al objetivo"],
  },
  {
    ...
    reviewStatus: "needs-master-review",
    reviewNote: "Prototipo de codo contra palma; validar altura y contacto del codo.",
    cues: ["Palma marca el blanco", "Codo golpea al centro", "Tronco gira", "Base estable"],
  },
  {
    ...
    reviewStatus: "needs-master-review",
    reviewNote: "Prototipo de defensa alta retorcida; validar giro, trayectoria y canto de mano.",
    cues: ["Canto de mano alto", "Movimiento hacia fuera", "Torso acompana", "Puno contrario recogido"],
  },
  {
    ...
    reviewStatus: "needs-master-review",
    reviewNote: "Prototipo de puno cubierto; validar altura y colocacion exacta de manos.",
    cues: ["Puno cubierto por palma", "Codos relajados", "Postura vertical", "Respiracion tranquila"],
  },
  {
    ...
    reviewStatus: "needs-master-review",
    reviewNote: "Prototipo de tijera; validar brazo alto/bajo, cruce y angulos con maestro.",
    cues: ["Un brazo protege arriba", "Otro brazo protege abajo", "Accion simultanea", "Centro estable"],
  },
  {
    ...
    reviewStatus: "needs-master-review",
    reviewNote: "Prototipo de rodillazo con agarre imaginado; validar manos, rodilla y equilibrio.",
    cues: ["Manos tiran hacia abajo", "Rodilla sube", "Cadera entra", "Pie de apoyo firme"],
  },
  {
    ...
    reviewStatus: "needs-master-review",
    reviewNote: "Prototipo de patada a palma; validar mano blanco, tipo de patada y recogida.",
    cues: ["Palma marca el objetivo", "Patada controlada", "Equilibrio", "Recogida limpia"],
  },
  {
    ...
    reviewStatus: "needs-master-review",
    reviewNote: "Prototipo muy provisional; validar forma exacta de montana con maestro.",
    cues: ["Forma amplia de brazos", "Un lado dominante", "Punios firmes", "Postura solida"],
  },
  {
    ...
    reviewStatus: "needs-master-review",
    reviewNote: "Prototipo de agarre y puno al menton; validar trayectoria y mano que tira.",
    cues: ["Una mano tira", "Puno al menton", "Cadera firme", "Foco corto y directo"],
  },
  {
    ...
    reviewStatus: "needs-master-review",
    reviewNote: "Prototipo de posicion; validar detalle de pies con maestro.",
    cues: ["Pies juntos", "Cuerpo erguido", "Brazos a los lados", "Mirada al frente"],
  },
  {
    ...
    reviewStatus: "needs-master-review",
    reviewNote: "Prototipo de preparacion; validar anchura exacta.",
    cues: ["Pies abiertos", "Punios preparados", "Hombros relajados", "Centro estable"],
  },
  {
    ...
    reviewStatus: "needs-master-review",
    reviewNote: "Prototipo de pies juntos; validar orientacion y postura.",
    cues: ["Pies unidos", "Postura vertical", "Equilibrio centrado", "Mirada frontal"],
  },
  {
    ...
    reviewStatus: "needs-master-review",
    reviewNote: "Prototipo de posicion corta; validar distancia entre pies.",
    cues: ["Paso corto", "Rodilla delantera suave", "Cadera natural", "Torso erguido"],
  },
  {
    ...
    reviewStatus: "needs-master-review",
    reviewNote: "Prototipo de posicion larga; validar profundidad y pie trasero.",
    cues: ["Paso largo", "Rodilla delantera flexionada", "Pierna trasera firme", "Cadera al frente"],
  },
  {
    ...
    reviewStatus: "needs-master-review",
    reviewNote: "Prototipo de jinete; validar anchura, rodillas y altura.",
    cues: ["Pies anchos", "Rodillas flexionadas", "Centro bajo", "Espalda erguida"],
  },
  {
    ...
    reviewStatus: "needs-master-review",
    reviewNote: "Prototipo de tigre; validar peso atras y apoyo delantero.",
    cues: ["Peso atras", "Pie delantero ligero", "Postura compacta", "Equilibrio listo"],
  },
  {
    ...
    reviewStatus: "needs-master-review",
    reviewNote: "Prototipo de posicion atrasada; validar reparto de peso.",
    cues: ["Peso en pierna trasera", "Cuerpo ligeramente lateral", "Rodillas flexionadas", "Base estable"],
  },
  {
    ...
    reviewStatus: "needs-master-review",
    reviewNote: "Prototipo de posicion cruzada; validar cruce y equilibrio.",
    cues: ["Pie cruza por detras", "Rodillas controladas", "Centro compacto", "Torso estable"],
  },
  {
    ...
    reviewStatus: "needs-master-review",
    reviewNote: "Prototipo de posicion paralela; validar anchura exacta.",
    cues: ["Pies paralelos", "Anchura equilibrada", "Cuerpo erguido", "Mirada frontal"],
  },
  {
    ...
    reviewStatus: "needs-master-review",
    reviewNote: "Prototipo orientado a izquierda; validar colocacion concreta de pies.",
    cues: ["Orientacion izquierda", "Pies visibles", "Postura formal", "Mirada acompana"],
  },
  {
    ...
    reviewStatus: "needs-master-review",
    reviewNote: "Prototipo orientado a derecha; validar colocacion concreta de pies.",
    cues: ["Orientacion derecha", "Pies visibles", "Postura formal", "Mirada acompana"],
  },
];
